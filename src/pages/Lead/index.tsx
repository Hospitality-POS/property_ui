    ...
    activities: [
      {
        date: '2025-02-28',
        type: 'Lead Created',
        notes: 'Lead captured from website inquiry form',
      },
      {
        date: '2025-02-28',
        type: 'Email Sent',
        notes: 'Welcome email with property catalog sent',
      },
    ],
  },
  {
    ...
    notes:
      'Interested in agricultural land for farming. Referred by David Maina.',
    priority: 'High',
    ...
    activities: [
      {
        date: '2025-02-15',
        type: 'Lead Created',
        notes: 'Lead from referral by David Maina',
      },
      {
        date: '2025-02-20',
        type: 'Phone Call',
        notes: 'Discussed land requirements and budget',
      },
      {
        date: '2025-03-01',
        type: 'Property Viewing',
        notes: 'Visited Thika Road land plots',
      },
    ],
  },
  {
    ...
    activities: [
      {
        date: '2025-02-10',
        type: 'Lead Created',
        notes: 'From Real Estate Exhibition in Mombasa',
      },
      {
        date: '2025-02-18',
        type: 'Email Sent',
        notes: 'Catalog of beachfront properties',
      },
      {
        date: '2025-02-25',
        type: 'Property Viewing',
        notes: 'Visited two beachfront apartments',
      },
      {
        date: '2025-03-03',
        type: 'Meeting',
        notes: 'Discussed terms for Garden View Apartment',
      },
    ],
  },
  {
    ...
    activities: [
      {
        date: '2025-03-02',
        type: 'Lead Created',
        notes: 'Facebook campaign lead',
      },
      {
        date: '2025-03-02',
        type: 'Email Sent',
        notes: 'Welcome email with brochure',
      },
    ],
  },
  {
    ...
    activities: [
      {
        date: '2025-01-20',
        type: 'Lead Created',
        notes: 'Website inquiry for Sunrise Heights',
      },
      {
        date: '2025-01-25',
        type: 'Property Viewing',
        notes: 'Visited Sunrise Heights project',
      },
      {
        date: '2025-02-10',
        type: 'Meeting',
        notes: 'Finalized unit selection and payment terms',
      },
      {
        date: '2025-03-01',
        type: 'Sale Completed',
        notes: 'Signed agreement and made initial payment',
      },
    ],
  },
  {
    ...
    activities: [
      ...
      },
      {
        date: '2025-01-30',
        type: 'Property Viewing',
        notes: 'Visited multiple land options',
      },
      {
        date: '2025-02-15',
        type: 'Follow-up Call',
        notes: 'Client is considering options',
      },
      {
        date: '2025-02-20',
        type: 'Closed Lost',
        notes: 'Client chose property from another developer',
      },
    ],
  },
];
  ...
  const filteredLeads = leadsData.filter(
    (lead) =>
      ...
      (leadAssigneeFilter === 'all' ||
        lead.assignedAgent === leadAssigneeFilter),
  );

  // Lead stage distribution for stats
  const leadsByStage = {
    'Initial Contact': leadsData.filter(
      (lead) => lead.stage === 'Initial Contact',
    ).length,
    'Property Viewing': leadsData.filter(
      (lead) => lead.stage === 'Property Viewing',
    ).length,
    Negotiation: leadsData.filter((lead) => lead.stage === 'Negotiation')
      .length,
    ...
    <>
        ...
        <Col xs={24} sm={12} md={6}>
          <Card>
            <Statistic
              ...
              value={Math.round(
                (leadsData.filter((lead) => lead.status === 'Closed Won')
                  .length /
                  leadsData.length) *
                  100,
              )}
          ...
          <Col span={6}>
            <div style={{ textAlign: 'center', padding: '8px 0' }}>
              <Progress
                type="circle"
                percent={100}
                format={() => leadsByStage['Initial Contact']}
                width={80}
              />
          ...
          <Col span={6}>
            <div style={{ textAlign: 'center', padding: '8px 0' }}>
              <Progress
                type="circle"
                percent={100}
                format={() => leadsByStage['Property Viewing']}
                width={80}
                strokeColor="#1890ff"
              />
          ...
          <Col span={6}>
            <div style={{ textAlign: 'center', padding: '8px 0' }}>
              <Progress
                type="circle"
                percent={100}
                format={() => leadsByStage['Negotiation']}
                width={80}
                strokeColor="#722ed1"
              />
      ...
      <Drawer
        ...
        extra={
          ...
          selectedLead.status !== 'Closed Lost' ? (
                ...
                <Card title="Lead Information" bordered={false}>
                  <Descriptions column={1}>
                    <Descriptions.Item label="Interest">
                      <Tag
                        color={
                          selectedLead.propertyInterest === 'Apartment'
                            ? 'blue'
                            : 'green'
                        }
                      >
                    ...
                    <Timeline.Item
                      ...
                      color={
                        activity.type === 'Lead Created'
                          ...
                          ? 'cyan'
                          : activity.type === 'Property Viewing'
                          ? 'purple'
                          : activity.type === 'Meeting'
                          ? 'orange'
                          : activity.type === 'Sale Completed'
                          ? 'green'
                          : activity.type === 'Closed Lost'
                          ? 'red'
                          : 'gray'
                      }
                    >
                    ...
                    <>
                      ...
                      <Descriptions>
                        ...
                        <Descriptions.Item label="Notes" span={3}>
                          Follow up on property interest and schedule viewing if
                          ready.
                        </Descriptions.Item>
                      </Descriptions>
        ...
        <Form layout="vertical">
            ...
            <Col span={12}>
              <Form.Item label="Lead Source">
                <Select
                  ...
                  onChange={(value) =>
                    setNewLead({ ...newLead, leadSource: value })
                  }
                  style={{ width: '100%' }}
                >
            ...
            <Col span={12}>
              <Form.Item label="Property Interest">
                <Select
                  ...
                  onChange={(value) =>
                    setNewLead({ ...newLead, propertyInterest: value })
                  }
                  style={{ width: '100%' }}
                >
          ...
          <Form.Item label="Assigned Agent">
            <Select
              ...
              onChange={(value) =>
                setNewLead({ ...newLead, assignedAgent: value })
              }
              style={{ width: '100%' }}
            >
              <Option value="Jane Njeri">Jane Njeri</Option>
        ...
        <Form layout="vertical">
          ...
          <Form.Item label="Schedule Next Follow-up">
            <DatePicker
              style={{ width: '100%' }}
              onChange={(date, dateString) =>
                setNewActivity({ ...newActivity, nextFollowUp: dateString })
              }
            />
          </Form.Item>
        </Form>
