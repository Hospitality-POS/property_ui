...
const PropertyTable = () => {
  ...
  const handleAddProperty = () => {
    ...
    const propertyToAdd = {
      ...
      totalSales: 0,
      expectedRevenue:
        newProperty.type === 'Development' ? 0 : newProperty.price,
    };
          ...
          <Tabs defaultActiveKey="1">
                ...
                <Col span={12}>
                  <Form.Item label="Price (KES)" required>
                    ...
                    {newPropertyType === 'Development' && (
                      <Text type="secondary">
                        Price will be set per unit type
                      </Text>
                    )}
                  </Form.Item>
                </Col>
              ...
              {newPropertyType === 'Development' && (
                <Form.Item label="Total Units">
                  <InputNumber
                    ...
                    onChange={(value) =>
                      setNewProperty({ ...newProperty, totalUnits: value })
                    }
                  />
                </Form.Item>
              )}
            ...
            <TabPane tab="Features & Documents" key="2">
              <Form.Item label="Features">
                <Select
                  ...
                  onChange={(values) =>
                    setNewProperty({ ...newProperty, features: values })
                  }
                >
                  {newPropertyType === 'Land' && (
                    <>
                      ...
                      <Option value="Commercial Zoning">
                        Commercial Zoning
                      </Option>
                      <Option value="Residential Zoning">
                        Residential Zoning
                      </Option>
                    </>
                  )}
              ...
              <Form.Item label="Required Documents">
                <Select
                  ...
                  onChange={(values) =>
                    setNewProperty({ ...newProperty, documents: values })
                  }
                >
                  {newPropertyType === 'Land' && (
                    <>
                      ...
                      <Option value="Clearance Certificate">
                        Clearance Certificate
                      </Option>
                      <Option value="Land Rates Receipt">
                        Land Rates Receipt
                      </Option>
                    </>
                  )}
                  ...
                  {newPropertyType === 'Apartment' && (
                    <>
                      ...
                      <Option value="Building Approval">
                        Building Approval
                      </Option>
                  ...
                  {newPropertyType === 'Development' && (
                    <>
                      ...
                      <Option value="Building Approvals">
                        Building Approvals
                      </Option>
              ...
              <Form.Item label="Property Images">
                <Upload.Dragger listType="picture-card" multiple>
                  ...
                  <p className="ant-upload-hint">
                    Support for multiple images. Please upload clear photos of
                    the property.
                  </p>
                </Upload.Dragger>
              </Form.Item>
            ...
            {newPropertyType === 'Development' && (
              <TabPane tab="Unit Types" key="4">
                ...
                <Text type="secondary">
                  For development projects, you can add different unit types
                  with their details and pricing. This will be available after
                  saving the project.
                </Text>
              </TabPane>
            )}
  ...
  return (
    <div>
      ...
      >
        ...
        <Space>
          <Tag
            color={property.type === 'Land' ? 'green' : 'blue'}
        ...
        <Col xs={24} md={8}>
          <Card title="Location Map" style={{ marginBottom: 24 }}>
            ...
            <List style={{ marginTop: 16 }}>
              ...
              <List.Item>
                <Text>
                  {property.county} County, {property.constituency} Constituency
                </Text>
              </List.Item>
              <List.Item>
          ...
          <Card title="Project Information" style={{ marginBottom: 24 }}>
            <List>
              <List.Item>
                <Text>
                  <UserOutlined /> Manager: {property.projectManager}
                </Text>
              </List.Item>
              <List.Item>
                <Text>
                  <CalendarOutlined /> Added: {property.dateAdded}
                </Text>
              </List.Item>
              <List.Item>
                <Text>
                  <ClockCircleOutlined /> Last Updated: {property.dateUpdated}
                </Text>
              </List.Item>
            </List>
          </Card>
              ...
              <Col xs={24} md={8}>
                ...
                <Card title="Location Map" style={{ marginBottom: 24 }}>
                  ...
                  <List style={{ marginTop: 16 }}>
                    ...
                    <List.Item>
                      <Text>
                        {project.county} County, {project.constituency}{' '}
                        Constituency
                      </Text>
                    </List.Item>
                    <List.Item>
                  ...
                  <Col span={24} md={8}>
                    ...
                    >
                      <Statistic
                        ...
                        value={
                          parseInt(project.constructionStatus.split('%')[0]) ||
                          0
                        }
                    ...
                    <Card title="Sales Timeline">
                      ...
                      <div>
                        ...
                        <div>
                          {project.salesProgress}% ({project.unitsSold}/
